...
window.PAPERS = [
  ...
  // ===== Dexterous manipulation & compliance (snowball additions, 2020+) =====
  {
    title: "A System for General In-Hand Object Re-Orientation",
    collection: "Dex Manipulation",
    file: null,
    image: null,
    note: "Sim-to-real RL that reorients 2000+ objects in-hand (face-up and face-down under gravity) via a teacher-student depth/gravity curriculum.",
    arxiv: "https://arxiv.org/abs/2111.03043",
    project: null,
    venue: "CoRL 2021",
    tags: ["dexterous", "manipulation", "in-hand-reorientation", "RL", "sim-to-real"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Extracts 3D hand-object trajectories from human videos and retargets them to a robot hand to learn relocate/pour/place via demo-augmented RL.",
    arxiv: "https://arxiv.org/abs/2108.05877",
    project: null,
    venue: "ECCV 2022",
    tags: ["dexterous", "manipulation", "imitation-learning", "RL", "human-video"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Bi-DexHands: a benchmark of 20 Isaac Gym bimanual dexterous tasks (hand-over, lift, throw-catch) with RL/multi-agent baselines.",
  ...
  },
  {
    ...
    file: null,
    image: null,
    note: "Learns continuous z-axis in-hand rotation of diverse objects on a real hand using rapid motor adaptation (RMA) sim-to-real from proprioception.",
    arxiv: "https://arxiv.org/abs/2210.04887",
    project: null,
    venue: "CoRL 2022",
    tags: ["dexterous", "manipulation", "in-hand-reorientation", "sim-to-real"]
  },
  {
    ...
    file: null,
    image: null,
    note: "RRT-style global planner over smoothed quasi-dynamic contact dynamics that plans contact-rich dexterous manipulation without learning.",
    arxiv: "https://arxiv.org/abs/2206.10787",
    project: null,
    venue: "T-RO 2023",
  ...
  },
  {
    ...
    file: null,
    image: null,
    note: "RotateIt: sim-to-real in-hand rotation about arbitrary axes fusing vision and touch, distilled from a privileged teacher into a multimodal student.",
    arxiv: "https://arxiv.org/abs/2309.09979",
    project: null,
    venue: "CoRL 2023",
    tags: ["dexterous", "manipulation", "in-hand-reorientation", "tactile", "sim-to-real"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Single-camera teleoperation to collect demos plus imitation learning that transfers across multi-finger hands for relocation tasks.",
    arxiv: "https://arxiv.org/abs/2204.12490",
    project: null,
    venue: "RA-L 2022",
  ...
  },
  {
    ...
    file: null,
    image: null,
    note: "Uses internet human videos as action/visual/physical priors to learn real-world dexterous policies, retargeting human hand motion to the robot.",
    arxiv: "https://arxiv.org/abs/2212.04498",
    project: null,
    venue: "CoRL 2022",
    tags: ["dexterous", "manipulation", "human-video"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Touch Dexterity: in-hand rotation using only a dense binary touch-sensor array (no vision), trained in sim and transferred to a real hand.",
    arxiv: "https://arxiv.org/abs/2303.10880",
    project: null,
    venue: "RSS 2023",
    tags: ["dexterous", "manipulation", "in-hand-reorientation", "tactile"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Synthesizes large bimanual dexterous demonstration datasets from a handful of human demos to train long-horizon two-hand imitation policies.",
    arxiv: "https://arxiv.org/abs/2410.24185",
    project: null,
    venue: "ICRA 2025",
    tags: ["dexterous", "manipulation", "bimanual", "imitation-learning"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Learns dexterous manipulation from state-only demonstrations by training an inverse dynamics model, removing the need for expert action labels.",
    arxiv: "https://arxiv.org/abs/2004.04650",
    project: null,
    venue: "IROS 2021",
  ...
  },
  {
    ...
    file: null,
    image: null,
    note: "DIME: teleoperates a multi-finger hand from a single camera and learns tasks (flipping, rotating, picking) from a few demos via nearest-neighbor imitation.",
    arxiv: "https://arxiv.org/abs/2203.13251",
    project: null,
    venue: "ICRA 2023",
    tags: ["dexterous", "manipulation", "in-hand-reorientation", "teleoperation", "imitation-learning"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Real-time human-to-robot hand retargeting learned from internet videos, enabling cheap teleoperation of a dexterous hand-arm system.",
    arxiv: "https://arxiv.org/abs/2202.10448",
    project: null,
    venue: "RSS 2022",
    tags: ["dexterous", "manipulation", "teleoperation", "human-video"]
  },
  {
    ...
    file: null,
    image: null,
    note: "RL on point-cloud observations (with imagined hand points) that generalizes dexterous manipulation to novel objects and transfers sim-to-real.",
    arxiv: "https://arxiv.org/abs/2211.09423",
    project: null,
    venue: "CoRL 2022",
    tags: ["dexterous", "manipulation", "RL", "sim-to-real", "point-cloud"]
  },
  {
    ...
    file: null,
    image: null,
    note: "HATO: bimanual visuotactile teleoperation hardware (two multi-finger hands with tactile sensing) plus imitation learning for contact-rich two-hand tasks.",
    arxiv: "https://arxiv.org/abs/2404.16823",
    project: null,
    venue: "ICRA 2025",
    tags: ["dexterous", "manipulation", "bimanual", "tactile", "contact-rich", "teleoperation", "imitation-learning"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Uses a mixed-reality headset for immersive real-time teleoperation of a dexterous hand to collect demos and learn manipulation via nearest-neighbor imitation.",
    arxiv: "https://arxiv.org/abs/2210.06463",
    project: null,
    venue: "ICRA 2023",
    tags: ["dexterous", "manipulation", "teleoperation", "imitation-learning"]
  },
  {
    ...
    file: null,
    image: null,
    note: "T-Dex: self-supervised pre-training of tactile representations from robot play, used for few-shot learning of contact-rich dexterous skills.",
    arxiv: "https://arxiv.org/abs/2303.12076",
    project: null,
    venue: "CoRL 2023",
    tags: ["dexterous", "manipulation", "tactile", "contact-rich"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Benchmark and RL method (3D point-cloud representation) for a multi-finger hand manipulating diverse articulated objects with generalization.",
  ...
  },
  {
    ...
    file: null,
    image: null,
    note: "Object-centric two-stage framework turning human MoCap object trajectories into bimanual/dexterous policies for non-grasping contact-rich skills.",
    arxiv: "https://arxiv.org/abs/2411.04005",
    project: null,
    venue: "CoRL 2024",
    tags: ["dexterous", "manipulation", "bimanual", "contact-rich", "human-video", "grasping"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Learns functional (tool-use) grasps for a real dexterous hand from internet-video affordances plus sim RL, grasping objects by the handle.",
    arxiv: "https://arxiv.org/abs/2312.02975",
    project: null,
    venue: "CoRL 2023",
    tags: ["dexterous", "manipulation", "RL", "tool-use", "grasping"]
  },
  {
    ...
    file: null,
    image: null,
    note: "PGDM: combines auto-computed pre-grasps with exemplar object trajectories to guide RL across many objects (TCDM benchmark).",
    arxiv: "https://arxiv.org/abs/2209.11221",
    project: null,
    venue: "ICRA 2023",
    tags: ["dexterous", "manipulation", "RL", "benchmark", "grasping"]
  },
  {
    ...
    file: null,
    image: null,
    note: "TAVI: optimizes tactile dexterous policies using visual reward (optimal-transport matching to human demos) for contact-rich multi-finger tasks.",
    arxiv: "https://arxiv.org/abs/2309.12300",
    project: null,
    venue: "ICRA 2024",
    tags: ["dexterous", "manipulation", "tactile", "contact-rich"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Sim-to-real dense tactile policy that rotates objects in-hand about arbitrary axes under any hand orientation (gravity-invariant).",
    arxiv: "https://arxiv.org/abs/2405.07391",
    project: null,
    venue: "CoRL 2024",
    tags: ["dexterous", "manipulation", "in-hand-reorientation", "tactile", "sim-to-real"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Benchmark and RL where simulated anthropomorphic hands learn to play 150 piano pieces, stressing high-precision bimanual finger coordination.",
  ...
  },
  {
    ...
    file: null,
    image: null,
    note: "Scales RL for dexterous hand-arm manipulation (regrasping, grasp-and-throw, reorientation) using massively parallel GPU sim plus population-based training.",
    arxiv: "https://arxiv.org/abs/2305.12127",
    project: null,
    venue: "RSS 2023",
    tags: ["dexterous", "manipulation", "in-hand-reorientation", "RL", "grasping"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Autonomous real-world RL learning vision-based dexterous manipulation with minimal human intervention via substep-guided reset-free training.",
    arxiv: "https://arxiv.org/abs/2212.09902",
    project: null,
    venue: "ICRA 2023",
    tags: ["dexterous", "manipulation", "RL"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Combines trajectory optimization to generate guiding trajectories with RL to solve hard multi-finger tasks (stacking, in-hand) in simulation.",
    arxiv: "https://arxiv.org/abs/2009.05104",
    project: null,
    venue: "ICML 2021",
    tags: ["dexterous", "manipulation", "in-hand-reorientation", "RL"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Deep RL that learns variable compliance (stiffness/damping) parameters for safe high-precision peg-in-hole assembly under contact uncertainty.",
    arxiv: "https://arxiv.org/abs/2008.10224",
    project: null,
    venue: "Applied Sciences 2020",
    tags: ["manipulation", "compliance", "contact-rich", "RL"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Slow latent diffusion policy plus a fast tactile/force-reactive refiner for compliant contact-rich manipulation, with AR tactile-feedback teleop.",
  ...
  },
  {
    ...
    file: null,
    image: null,
    note: "Inverse RL recovers both a variable-impedance policy and reward from demos for force tasks (peg-in-hole, cup-on-plate) on a real arm.",
    arxiv: "https://arxiv.org/abs/2102.06838",
    project: null,
    venue: "RA-L 2021",
    tags: ["manipulation", "force-control", "impedance", "contact-rich", "RL"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Point-cloud visuotactile representation fusing vision and touch/contact for RL-based in-hand object rotation with sim-to-real transfer.",
  ...
  },
  {
    ...
    file: null,
    image: null,
    note: "Force-centric imitation with a handheld force-motion capture system, learning force-conditioned policies for tasks like vegetable peeling.",
  ...
  },
  {
    ...
    file: null,
    image: null,
    note: "Adds a force-aware mixture-of-experts module to a vision-language-action model so policies adapt to contact forces in contact-rich manipulation.",
  ...
  },
  {
    ...
    file: null,
    image: null,
    note: "Diffusion policy that jointly predicts motion and time-varying target compliance (stiffness), modulating compliance online for contact-rich tasks.",
    arxiv: "https://arxiv.org/abs/2410.09309",
    project: null,
    venue: "ICRA 2025",
    tags: ["manipulation", "compliance", "contact-rich", "diffusion"]
  },
  {
    ...
    file: null,
    image: null,
    note: "Learns contact-rich/compliant policies from multimodal human tactile (force) demonstrations, transferring touch-guided control to the robot.",
    arxiv: "https://arxiv.org/abs/2310.16917",
    project: null,
    venue: "CoRL 2024",
  ...
  },
  {
    ...
    file: null,
    image: null,
    note: "RL that directly learns end-effector force control (not just position) for contact-rich manipulation, demonstrated on a legged manipulator.",
    arxiv: "https://arxiv.org/abs/2405.01402",
    project: null,
    venue: "ICRA 2024",
  ...
  },
  {
    ...
    file: null,
    image: null,
    note: "Uses measured contact forces during kinesthetic demos to compute force-informed actions, improving learned contact-rich dexterous policies.",
    arxiv: "https://arxiv.org/abs/2501.10356",
    project: null,
    venue: "RA-L 2025",
    tags: ["manipulation", "tactile", "force-control", "contact-rich", "imitation-learning"]
  },

  // ===== Foundational references (for citation) =====
  {
