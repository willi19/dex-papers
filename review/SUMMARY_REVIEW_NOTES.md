...
**같은 날 두 번 나온 하위 패턴: 추상 요약을 구체 사실 앞에 놓기.**
"Figure 4 backs the reading ... the prior acts by degree"와 "a threaded joint has no faithful
cheap model" 둘 다, 바로 뒤(또는 다른 필드)에 있는 구체적 사실을 한 번 더 추상어로 요약해서
앞에 세운 경우다. 추상 문장은 정보를 더하지 않으면서 **읽는 사람이 두 번 해석하게 만든다.**
구체적인 쪽만 남기면 된다.
